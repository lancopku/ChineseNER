    ...
    def __init__(self, read_model, hnum, ynum, wnum, dnum, wsize, fsize, L2, fnum0, fnum1, fnum2, fnum3, fnum4, kalpha):
       ...
       # self.Aij = theano.shared()
        ...
        def viterbi(p_y, A):
            ...
            y_pred = T.cast(y_pred, dtype='int32')
            return y_pred
        ...
        def confid(p_y, A):
            ...
            sortscore = T.argsort(scanned[-1], axis=0)
            confidence = ((sortscore[-1] - sortscore[-2]) / (sortscore[-1]+0.0000001))/-10000000000
            return confidence

        confidence = confid(p_y, self.A)
        ...
        self.get_confid = theano.function(inputs=[idxs, f0idxs, f1idxs, f2idxs, f3idxs, f4idxs],
                                              outputs= confidence)
